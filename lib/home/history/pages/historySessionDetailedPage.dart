...
class HistorySessionDetailPage extends StatefulWidget {
  ...
  @override
  State<HistorySessionDetailPage> createState() =>
      _HistorySessionDetailPageState();
}

class _HistorySessionDetailPageState extends State<HistorySessionDetailPage> {
  late final HistorySessionDetailVM vm;
